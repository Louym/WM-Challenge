# World-model demo comparison on sample demo_42

Input: `SANA_WM_dev/playground/dataset/dataset/demo_42.png` + `demo_42.txt` prompt.
...
|---|---|---|---|---|---|---|---|---|---|---|
| infworld_clip.mp4 | Infinite-World | default | causal (chunk-autoregressive) | clip-by-clip | 20 x 49 | 16 | 896x448 | 61.26 | 819.0 | whole-video mode not supported (fixed 49-frame chunks) |
| sana_wm_bidirectional_clip.mp4 | Sana-WM | bidirectional 1600M 720p + refiner | bidirectional | clip-by-clip | 20 x 49 | 16 | 1280x704 | 60.0 | 1179.0 | refiner on; Pi3X-estimated intrinsics; flow_shift 8 |
| sana_wm_bidirectional_whole.mp4 | Sana-WM | bidirectional 1600M 720p + refiner | bidirectional | whole-video | 1 x 961 | 16 | 1280x704 | 60.0 | 900.0 | 961 frames in one shot |
| hy_ar_distill_clip.mp4 | HY-WorldPlay | ar_distill | causal (autoregressive) | clip-by-clip | 12 x 125 | 24 | 832x480 | 62.51 | 640.0 | chunk_latent_frames=4 |
| hy_ar_clip.mp4 | HY-WorldPlay | ar | causal (autoregressive) | clip-by-clip | 12 x 125 | 24 | 832x480 | 62.51 | 3689.0 | chunk_latent_frames=4 |
| hy_ar_rl_clip.mp4 | HY-WorldPlay | ar_rl | causal (autoregressive) | clip-by-clip | 12 x 125 | 24 | 832x480 | 62.51 | 3704.0 | chunk_latent_frames=4 |
| hy_bi_clip.mp4 | HY-WorldPlay | bi | bidirectional | clip-by-clip | 12 x 125 | 24 | 832x480 | 62.51 | 5726.0 | chunk_latent_frames=16 |
...
| lingbot_small_clip.mp4 | LingBot-World | small/fast (distilled streaming) | causal (chunked streaming) | clip-by-clip | 20 x 57 | 16 | 832x464 | 71.26 | 628.0 | i2v-A14B; 49-frame request snapped to 57 (3-latent chunking) |
...
Latency detail: `latency_demo_42.csv` (model load, first-segment, avg per-segment, total).
